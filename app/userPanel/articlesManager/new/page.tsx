...
export default function CreateArticlePage() {
  ...
  useEffect(() => {
    let editeslug = articleMainData.slug.replace(/ /g, "-");
  ...
  const editor = useEditor({
    ...
    content: `
            ...
            <p>متن مقاله را اینجا بنویسید...</p>
        `,
  });
  ...
  const handelCategory = (event?: any) => {
    ...
    if (articleMainData.oneCategory === "") {
      toast.dark("هیچ مقداری وارد نشده است ... !");
      return;
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error(
          ` خطا در ساخت مقاله: ${errorData.message || response.statusText}`,
        );
      } else {
  ...
  useEffect(() => {
    document.title = 'ادمین پنل | ایجاد مقاله';
  }, []);
  ...
  const ToolbarButton = ({
    ...
    <button
      onClick={onClick}
      title={title}
      className={`p-2 rounded hover:bg-[var(--foreground)] hover:text-[var(--background)] cursor-pointer transition min-w-[40px] ${isActive ? "bg-[var(--foreground)] text-[var(--background)]" : ""
        }`}
    >
      {children}
    </button>
  ...
  return (
    <>
      ...
      <div className="container articlsStyle mx-auto p-6 flex flex-wrap justify-between w-full">
        ...
        <h1 className="text-3xl font-bold mb-6 w-full">ایجاد مقاله جدید</h1>
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="absolute top-0 left-0 ccdiv w-full h-full">
                              <img src={auo.cover} className="!w-full !h-full" />
                            </p>
                            <button
                              onClick={() => {
                                if (editor && auo) {
        ...
        {/* <MediaUploaded
                    ...
                    mediaType={[{name: 'بارگذاری تصویر', type: 'img', function: 'articleImg'}]}
                /> */}
        <div className="editment w-[100%] xl:w-[70%]">
          <div className="flex flex-wrap gap-5">
            ...
            <div className="">
              ...
              />
              <p className="urlp">
                https://amlakpol.ir/article/<span>{articleMainData.slug}</span>
              </p>
            </div>
          ...
          <div className="bg-[var(--inputback)] rounded-t-lg p-2 flex flex-wrap gap-1 sticky top-0 z-10">
            ...
            <button
              ...
              title="حذف رنگ"
            >
              <div className="w-[25px] h-[25px] ccdiv bg-[var(--foreground)] text-[var(--background)] mx-2 cursor-pointer rounded">ب</div>
            </button>
            ...
            <button
              ...
              title="قرمز"
            >
              <div className="w-[25px] h-[25px] ccdiv bg-red-500 mx-2 cursor-pointer rounded">ب</div>
            </button>
            ...
            <button
              ...
              title="طلایی"
            >
              <div className="w-[25px] h-[25px] ccdiv bg-[var(--title)] mx-2 cursor-pointer rounded">ب</div>
            </button>
          ...
          <button
            onClick={() => {
              if (confirm("مطمئن هستید؟ همه تغییرات پاک می‌شود.")) {
                ...
                articleMainData.categories = [];
              }
            }}
            className="transition-all duration-500 mt-5 border border-red-600 text cursor-pointer hover:bg-red-600 hover:text-[var(--background)] px-6 py-3 rounded-lg font-medium"
          >
            پاک کردن همه
          </button>
